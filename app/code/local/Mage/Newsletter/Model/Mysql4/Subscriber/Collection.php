...
class Mage_Newsletter_Model_Mysql4_Subscriber_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract
{
    ...
    public function showCustomerInfo()
    {
        ...
        $username   = $customer->getAttribute('username');
...
//        $lastname  = $customersCollection->getAttribute('lastname');
        ...
        $this->getSelect()
            ->joinLeft(
             ...
             ->joinLeft(
                array('customer_username_table'=>$username->getBackend()->getTable()),
                'customer_username_table.entity_id=main_table.customer_id
                 AND customer_username_table.attribute_id = '.(int) $username->getAttributeId() . '
                 ',
                array('customer_username'=>'value')
             )
             ->joinLeft(
