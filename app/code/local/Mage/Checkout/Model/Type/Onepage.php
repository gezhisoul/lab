...
class Mage_Checkout_Model_Type_Onepage
{
    ...
    public function validate()
    {
        ...
        if (!($shippingAddress = $quote->getShippingAddress())) {
            Mage::throwException($helper->__('Invalid shipping address.'));
        } else {
            if (!($shippingMethod = $shippingAddress->getShippingMethod())) {
                Mage::throwException($helper->__('Invalid shipping method.'));
            } else {
                Mage::log('shipping method is: '.var_export($shippingMethod, true));
            }
        }
    ...
    public function saveOrder()
    {
        ...
        Mage::log('order save success. increment id: '.$order->getIncrementId());
        return $this;
    }
