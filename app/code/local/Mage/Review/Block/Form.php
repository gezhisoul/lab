...
class Mage_Review_Block_Form extends Mage_Core_Block_Template
{
    ...
    public function getBuyReview()
    {
      $customer_id = Mage::getSingleton('customer/session')->getCustomer()->getData('entity_id');
         
      $product_id = Mage::registry('product')->getData('entity_id');

      $read = Mage::getSingleton('core/resource')->getConnection('core_read');
      
      $qry = "select r_status from review_yes where product_id = '".$product_id."' and customer_id = '".$customer_id."' order by id desc"; //
